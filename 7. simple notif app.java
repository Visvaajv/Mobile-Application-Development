...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void notificationWithImage() {
        Person bot = new Person.Builder()
                .setName("Bot").setImportant(true).setBot(true).build();

        Uri uri = Uri.parse("android.resource://" + getPackageName() + "/" + R.drawable.bg);

        NotificationCompat.MessagingStyle.Message message =
                new NotificationCompat.MessagingStyle.Message("Check out my latest article!", new Date().getTime(), bot);
    ...
    private void notificationWithGroupConvo() {
        Person jd = new Person.Builder().setName("JournalDev").build();
        ...
        NotificationCompat.MessagingStyle.Message message =
                new NotificationCompat.MessagingStyle.Message("", new Date().getTime(), bot);
        message.setData("image/*", uri);
